...
export class ContactUs implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.seo.updateSeo({
      ...
      keywords: 'contact Feather Dynamics, UAV inquiry, defense drone inquiry, UAS sales, tactical drone sales, NDAA drone supplier, defense contractor contact, military UAV inquiry, ISR platform sales, made in USA drone, Blue UAS Select supplier, drone procurement, autonomous drone company, Feather Dynamics USA, defense technology partners'
    });
